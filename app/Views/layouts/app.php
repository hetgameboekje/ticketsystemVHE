    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($magAssets): ?>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle<?= dropdownActive(['assets', 'voorraad', 'uitgiften', 'printers'], $active) ?>"
                       href="#"
                       id="assetsDropdown"
                       role="button"
                       data-bs-toggle="dropdown"
                ...
                <?php if ($magOnderhoud): ?>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle<?= dropdownActive(['onderhoud', 'schijfgebruik', 'apparaten', 'scripts'], $active) ?>"
                       href="#"
                       id="onderhoudDropdown"
                       role="button"
                       data-bs-toggle="dropdown"
                       aria-expanded="false">
                        Onderhoud
