  ...
  <div class="card" style="margin-bottom:16px">
    <div style="padding:16px">
      ...
      <div class="form-group">
        ...
        <input type="text" name="categorie" id="categorie-input" list="categorie-opties" placeholder="bijv. Netwerk & Connectiviteit, Password & Security" autocomplete="off">
        <datalist id="categorie-opties"></datalist>
      </div>
      <div class="form-group">
        <label class="form-label">Subcategorie</label>
        <input type="text" name="subcategorie" id="subcategorie-input" list="subcategorie-opties" placeholder="optioneel" autocomplete="off">
        <datalist id="subcategorie-opties"></datalist>
      </div>
      <div class="form-group">
        <label class="form-label">Samenvatting</label>
        <input type="text" name="samenvatting" placeholder="Korte omschrijving voor in de artikellijst" maxlength="255">
      </div>
      <div class="form-group">
        <label class="form-label">Tags</label>
        <input type="text" name="tags" id="tags-input" list="tags-opties" placeholder="komma-gescheiden, bijv. vpn, netwerk, remote" autocomplete="off">
